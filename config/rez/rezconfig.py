# Create an environment variable REZ_CONFIG_FILE pointing to this file
# example : REZ_CONFIG_FILE = <rez_install_dir>/rezconfig.py

# Create an environment variable REZ pointing to the rez installation dir
...
rez_install_dir = os.getenv("REZ") or os.getenv("HOME")
...
packages_path = [
    os.path.join(str(rez_install_dir), "Packages"),
    os.path.join(str(rez_install_dir), "Packages", "local_packages"),
    os.path.join(str(rez_install_dir), "Packages", "external_packages"),
    os.path.join(str(rez_install_dir), "Packages", "pip_packages"),
    os.path.join(str(rez_install_dir), "Packages", "cmake_packages"),
    os.path.join(str(rez_install_dir), "Packages", "scoop_packages"),
    os.path.join(str(rez_install_dir), "Packages", "apt_packages"),
    os.path.join(str(rez_install_dir), "Packages", "yum_packages"),
    os.path.join(str(rez_install_dir), "Packages", "dcc_packages"),
    os.path.join(str(rez_install_dir), "Packages", "silex_packages"),
]

# The path that Rez will locally install packages to when rez-build is used
local_packages_path = os.path.join(str(rez_install_dir), "Packages",
                                   "local_packages")
...
release_packages_path = os.path.join(str(rez_install_dir), "Packages",
                                     "external_packages")
